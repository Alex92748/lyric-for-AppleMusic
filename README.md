...
cp .build/release/lyric /Applications/lyric.app/Contents/MacOS/lyric
```

或者直接下载 Release 中的 `lyric.app`。

## 使用

1. 打开 `lyric.app`
2. 打开 Apple Music 播放歌曲
3. 歌词会自动显示在桌面底部
...
- **AppleScript 校准** — 每 100ms 通过 AppleScript 获取 `player position`
